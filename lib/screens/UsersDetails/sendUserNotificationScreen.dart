...
class SendUserNotification extends StatelessWidget {
  static const String routeName = "/send-user-notification-page";
  SendUserNotification({Key? key, required this.userModel}) : super(key: key);
